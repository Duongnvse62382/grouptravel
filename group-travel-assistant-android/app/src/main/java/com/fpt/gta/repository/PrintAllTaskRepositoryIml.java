...
public class PrintAllTaskRepositoryIml implements PrintAllTaskRepository {
    @Override
    public void printAllTask(Context context, Integer idActivity, CallBackData<List<TaskDTO>> callBackData) {
        ClientApi clientApi = new ClientApi();
        Call<ResponseBody> bodyCall = clientApi.gtaService().getAllTaskInActivity(idActivity);
