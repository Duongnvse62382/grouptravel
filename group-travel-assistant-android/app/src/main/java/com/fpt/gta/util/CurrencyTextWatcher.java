...
public class CurrencyTextWatcher implements TextWatcher {
    ...
    public CurrencyTextWatcher(EditText etAmount, int scale) {
        this.etAmount = etAmount;
        this.scale = scale;
    }

    public CurrencyTextWatcher(EditText etAmount) {
        this.etAmount = etAmount;
    }
    ...
    public void afterTextChanged(Editable s) {
        ...
        etAmount.setFilters(new InputFilter[]{new MoneyValueFilter(scale)});
