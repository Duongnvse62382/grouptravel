...
public class PrintBudgetElectedPlanRepositoryIml implements PrintBudgetElectedPlanRepository {
    @Override
    public void printBudgetElectedPlan(Context context, int groupId, CallBackData<List<TripReponseDTO>> callBackData) {
        ClientApi clientApi = new ClientApi();
        Call<ResponseBody> responseBody = clientApi.gtaService().getAllBudgetElectedPlan(groupId);
