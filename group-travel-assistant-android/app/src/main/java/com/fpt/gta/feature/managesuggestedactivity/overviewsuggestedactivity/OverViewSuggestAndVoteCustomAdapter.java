...
public class OverViewSuggestAndVoteCustomAdapter implements SmartTabLayout.TabProvider {

    private Context mContext;
    private FragmentPagerItems fragmentPagerItems;

    public OverViewSuggestAndVoteCustomAdapter(Context mContext, FragmentPagerItems fragmentPagerItems) {
