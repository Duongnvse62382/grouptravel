...
public class UpdateActivity extends AppCompatActivity implements UpdateActivityView {
    ...
    public void initData() {
        imgUpdateActivityDocument.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(UpdateActivity.this, ActivityDocumentActivity.class);
        ...
        if (idType.equals(ActivityType.ACTIVITY)) {
            edtUpdateActivityType.setText("Activity");
        } else if (idType.equals(ActivityType.FOODANDBEVERAGE)) {
            edtUpdateActivityType.setText("Food And Beverage");
...
//        });
        ...
        edtUpdateActivityType.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
...
//            edtUpdateActivityEndAddress.setVisibility(View.VISIBLE);
//            lnlAddPlaceActivity.setVisibility(View.GONE);
...
//        }
        ...
        imgAddActivityPlace.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                edtUpdateActivityEndLocationName.setText("");
                edtUpdateActivityEndAddress.setText("");
            }
        });
    ...
    public void initPlace() {
        ...
        edtUpdateActivityStartLocationName.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(UpdateActivity.this, PlaceAutoCompleteActivity.class);
    ...
    public void clickUpdateActivity() {
        try {
            ...
            if (!checkNull() || !checkValidationSave(timeStart, timeEnd, dateStart, dateEnd, timez)) {
                ...
                planId = SharePreferenceUtils.getIntSharedPreference(UpdateActivity.this, GTABundle.PLANID);
