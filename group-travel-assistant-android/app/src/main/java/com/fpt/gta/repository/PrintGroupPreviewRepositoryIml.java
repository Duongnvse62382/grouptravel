...
public class PrintGroupPreviewRepositoryIml implements PrintGroupPreviewRepository {
    @Override
    public void printGroupPreview(Context context, String idGroup, CallBackData<GroupResponseDTO> callBackData) {
        ClientApi clientApi = new ClientApi();
        Call<ResponseBody> bodyCall = clientApi.gtaService().getViewGroupPreview(idGroup);
