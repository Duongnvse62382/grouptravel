...
public class PrintHighestVotePlanRepositoryIml implements PrintHighestVotePlanRepository{

    @Override
    public void getHighestVotePlan(Context context, Integer idTrip, CallBackData<List<PlanDTO>> callBackData) {
        ClientApi clientApi = new ClientApi();
        Call<ResponseBody> bodyCall = clientApi.gtaService().getHighestVotePlan(idTrip);
