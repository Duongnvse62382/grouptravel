...
public class ActivityDetailViewUserActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void initData() {
        ...
        activityDTO = (ActivityDTO) bundle.getSerializable(GTABundle.ACTIVITYDTOVIEW);
