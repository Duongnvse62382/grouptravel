...
public class SearchPlaceRepositoryIml implements SearchPlaceRepository {
    @Override
    public void searchPlace(Context context, String srearchValues, CallBackData<List<PlaceDTO>> callBackData) {
        ClientApi clientApi = new ClientApi();
        Call<ResponseBody> bodyCall = clientApi.gtaService().autocompletePlaceAll(srearchValues);
