...
public class DeleteTransactionRepositoryIml implements DeleteTransactionRepository {
    @Override
    public void deleteTransaction(Context mContext, int idTransaction, CallBackData callBackData) {
        ClientApi clientApi = new ClientApi();
        Call<ResponseBody> bodyCall = clientApi.gtaService().deleteTransaction(idTransaction);
