...
public class AddTransactionDocumentActivity extends AppCompatActivity {
    private int groupId;
    private static final int RESULT_LOAD_IMAGE = 1;
    private ImageButton mSelectBtn, imgSaveImageTransacion;
    ...
    private ImageView imgAddTransactionDocumentBack;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_transaction_document);
        initView();
        initData();
    }

    private void initView() {
        groupId = SharePreferenceUtils.getIntSharedPreference(AddTransactionDocumentActivity.this, GTABundle.IDGROUP);
        Bundle bundle = getIntent().getExtras();
        mDocumentDTOList = (List<DocumentDTO>) bundle.getSerializable(GTABundle.ADD_TRANSACTION_DOCUMENT);
        mStorage = FirebaseStorage.getInstance().getReference();
        mSelectBtn = (ImageButton) findViewById(R.id.img_add_transaction_document);
        imgSaveImageTransacion = (ImageButton) findViewById(R.id.imgSaveImageTransacion);
        imgAddTransactionDocumentBack = (ImageView) findViewById(R.id.imgAddTransactionDocumentBack);
        rcvDocumentList = (RecyclerView) findViewById(R.id.rcvUploadTrasactionDocument);
        //RecyclerView
    ...
    private void initData() {
        ...
        imgSaveImageTransacion.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        imgAddTransactionDocumentBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                finish();
            }
...
//                        Snackbar.make(view, "Permission Denied, You cannot access location data and camera.", Snackbar.LENGTH_LONG).show();
    ...
    private void showMessageOKCancel(String message, DialogInterface.OnClickListener okListener) {
        new AlertDialog.Builder(AddTransactionDocumentActivity.this)
                .setMessage(message)
    ...
    private void showTransactionDocumentType() {
        final Dialog dialog = new Dialog(AddTransactionDocumentActivity.this);
            ...
            public void onClick(View view) {
                if (checkPermission()) {
                    ...
                    if (checker.equals("group")) {
                        Intent intent = new Intent(AddTransactionDocumentActivity.this, AddGroupDocumentToTransactionActivity.class);
                        Bundle bundle = new Bundle();
                        bundle.putString("CALLING_ACTIVITY", "TransactionDocumentActivity");
                        bundle.putSerializable(GTABundle.ADD_TRANSACTION_DOCUMENT_GROUP, (Serializable) mDocumentDTOList);
                        intent.putExtras(bundle);
                        startActivityForResult(intent, GTABundle.ADD_TRANSACTION_DOCUMENT_GROUP_CODE);
                    }
                } else if (!checkPermission()) {
                    requestPermission();
                }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == RESULT_LOAD_IMAGE && resultCode == RESULT_OK) {
            if (data.getClipData() != null) {
                ...
                for (int i = 0; i < data.getClipData().getItemCount(); i++) {
                    check = HandleFile.checkFileUpload(AddTransactionDocumentActivity.this, data.getClipData().getItemAt(i).getUri());
                    if (check == false) {
                        break;
                    }
                }
                if (check == true) {
                    ...
                    builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            final KProgressHUD khub = KProgressHUDManager.showProgressBar(AddTransactionDocumentActivity.this);
                            int totalItemsSelected = data.getClipData().getItemCount();
                            for (int i = 0; i < totalItemsSelected; i++) {
                                Uri fileUri = data.getClipData().getItemAt(i).getUri();
                                ContentResolver cR = AddTransactionDocumentActivity.this.getContentResolver();
                                ...
                                if (contentType.equals("application/pdf")) {
                                    DocumentImageUtil
                                            .getPdfThumbnailBitmap(AddTransactionDocumentActivity.this, getContentResolver(), fileUri)
                                            .thenAccept(bitmap -> {
                                ...
                                fileToUpload.putFile(fileUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                                    ...
                                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                        ...
                                        Toast.makeText(AddTransactionDocumentActivity.this, "Uploaded " + " " + totalItemsSelected + " " + "File Succesfully", Toast.LENGTH_SHORT).show();
                                        KProgressHUDManager.dismiss(AddTransactionDocumentActivity.this, khub);
                                    }
                                });
                            }
                        }
                ...
                boolean check = true;
                check = HandleFile.checkFileUpload(AddTransactionDocumentActivity.this, data.getData());
                if (check == true) {
                    AlertDialog.Builder builder = new AlertDialog.Builder(this);
                    builder.setMessage("Are you sure to upload this file?");
                    builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            if (contentType.equals("application/pdf")) {
                                DocumentImageUtil
                                        .getPdfThumbnailBitmap(AddTransactionDocumentActivity.this, getContentResolver(), uri)
                                        .thenAccept(bitmap -> {
                                            ByteArrayOutputStream baos = new ByteArrayOutputStream();
                                            bitmap.compress(Bitmap.CompressFormat.PNG, 100, baos);
                                            byte[] imageBytes = baos.toByteArray();
                            ...
                            fileToUpload.putFile(uri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                                ...
                                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                    ...
                                    Toast.makeText(AddTransactionDocumentActivity.this, "Uploaded 1 File Succesfully", Toast.LENGTH_SHORT).show();
                                    KProgressHUDManager.dismiss(AddTransactionDocumentActivity.this, khub);
                                }
                            });
                        }
            ...
            boolean check = true;
            check = HandleFile.checkFileUpload(AddTransactionDocumentActivity.this, uriImage);
            if (check == true) {
                AlertDialog.Builder builder = new AlertDialog.Builder(this);
                builder.setMessage("Are you sure to upload this file?");
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        fileToUpload.putFile(uriImage).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                            ...
                            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                ...
                                Toast.makeText(AddTransactionDocumentActivity.this, "Uploaded Successfully", Toast.LENGTH_SHORT).show();
                                KProgressHUDManager.dismiss(AddTransactionDocumentActivity.this, khub);
                            ...
                            public void onFailure(@NonNull Exception e) {
                                Toast.makeText(AddTransactionDocumentActivity.this, "failed", Toast.LENGTH_LONG).show();
        ...
        } else if (requestCode == GTABundle.ADD_TRANSACTION_DOCUMENT_IMAGE_CODE) {
            if (resultCode == RESULT_OK) {
                documentDTO = (DocumentDTO) data.getSerializableExtra(GTABundle.ADD_TRANSACTION_DOCUMENT_IMAGE);
        ...
        } else if (requestCode == GTABundle.UPDATE_DOCUMENT_PDF_TRANSACTION_CODE) {
            if (resultCode == RESULT_OK) {
                documentDTO = (DocumentDTO) data.getSerializableExtra(GTABundle.UPDATE_DOCUMENT_PDF_TRANSACTION);
                mDocumentDTOList.removeIf(removingDocumentDTO -> removingDocumentDTO.getDownloadThumbnailUrl().compareTo(documentDTO.getDownloadThumbnailUrl()) == 0);
                updateUI();
            }
        } else if (requestCode == GTABundle.ADD_TRANSACTION_DOCUMENT_GROUP_CODE) {
            if (resultCode == RESULT_OK) {
                mDocumentDTOList = (List<DocumentDTO>) data.getSerializableExtra(GTABundle.ADD_TRANSACTION_DOCUMENT_GROUP);
                updateUI();
            }
        }
    }
    ...
    public void onClicPDF(DocumentDTO documentDTO) {
        Intent intent = new Intent(AddTransactionDocumentActivity.this, PdfViewActivity.class);
        Bundle bundle = new Bundle();
        bundle.putString("CALLING_ACTIVITY", "AddTransactionDocumentActivity");
        bundle.putSerializable(GTABundle.UPDATE_DOCUMENT_PDF_TRANSACTION, documentDTO);
        intent.putExtras(bundle);
        startActivityForResult(intent, GTABundle.UPDATE_DOCUMENT_PDF_TRANSACTION_CODE);
    }

    public void onClickImage(DocumentDTO documentDTO) {
        Intent intent = new Intent(AddTransactionDocumentActivity.this, ImageOpenActivity.class);
        Bundle bundle = new Bundle();
        bundle.putString("CALLING_ACTIVITY", "AddTransactionDocumentActivity");
        bundle.putSerializable(GTABundle.ADD_TRANSACTION_DOCUMENT_IMAGE, documentDTO);
        intent.putExtras(bundle);
        startActivityForResult(intent, GTABundle.ADD_TRANSACTION_DOCUMENT_IMAGE_CODE);
    }
}