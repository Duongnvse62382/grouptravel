...
public class SearchPlaceCitiesRepositoryIml implements SearchPlaceCitiesRepository{
    @Override
    public void searchPlaceCities(Context context, String srearchValues, CallBackData<List<PlaceDTO>> callBackData) {
        ClientApi clientApi = new ClientApi();
        Call<ResponseBody> bodyCall = clientApi.gtaService().autocompleteCities(srearchValues);
