...
public class GroupInComingAdapter extends RecyclerView.Adapter<GroupInComingAdapter.ViewHolder> {
    ...
    public GroupInComingAdapter(List<GroupResponseDTO> listGroup, Context mContext) {
    ...
    public void notifyDataChangeGoingTo(List<GroupResponseDTO> dtos) {
